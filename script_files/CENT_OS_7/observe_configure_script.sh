...
getFiles(){
    curl         https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts//script_files/CENT_OS_7/osquery.flags
 > config_files/osquery.flags
curl         https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts//script_files/CENT_OS_7/osquery.conf
 > config_files/osquery.conf
curl         https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts//script_files/CENT_OS_7/td-agent-bit.conf
 > config_files/td-agent-bit.conf
curl         https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts//script_files/CENT_OS_7/telegraf.conf
