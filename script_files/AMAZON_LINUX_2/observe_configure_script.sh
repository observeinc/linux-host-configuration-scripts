...
getFiles(){
    curl https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts/''/script_files/AMAZON_LINUX_2/osquery.conf > config_files/osquery.conf
curl https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts/''/script_files/AMAZON_LINUX_2/td-agent-bit.conf > config_files/td-agent-bit.conf
curl https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts/''/script_files/AMAZON_LINUX_2/telegraf.conf > config_files/telegraf.conf
curl https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts/''/script_files/AMAZON_LINUX_2/osquery.flags > config_files/osquery.flags
