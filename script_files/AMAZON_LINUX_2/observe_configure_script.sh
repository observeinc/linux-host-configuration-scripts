...
getFiles(){
    curl https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts/37738branch_input/script_files/AMAZON_LINUX_2/osquery.flags > config_files/osquery.flags
curl https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts/37743branch_input/script_files/AMAZON_LINUX_2/telegraf.conf > config_files/telegraf.conf
curl https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts/37746branch_input/script_files/AMAZON_LINUX_2/osquery.conf > config_files/osquery.conf
curl https://raw.githubusercontent.com/observeinc/linux-host-configuration-scripts/37749branch_input/script_files/AMAZON_LINUX_2/td-agent-bit.conf > config_files/td-agent-bit.conf
