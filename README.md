![Pass/Fail Tests - AWS](https://github.com/observeinc/linux-host-configuration-scripts/actions/workflows/fabric-install-tests-aws.yaml/badge.svg?branch=main) - AWS EC2
