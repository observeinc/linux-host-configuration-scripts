...
sudo apt-key adv --keyserver keyserver.ubuntu.com --recv-keys 9F9DDC083888C1CD
...
# curl https://raw.githubusercontent.com/observeinc/host-config-scripts/main/opentelemetry/linux/observe_otel_install.sh | bash -s -- --observe_collection_endpoint ${OBSERVE_ENDPOINT} --observe_token ${OBSERVE_TOKEN}
